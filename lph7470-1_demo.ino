...
void setup() {
  ...
  analogWrite(PWMPIN, 127); //output 3 volt PWM signal on pin 3 for the voltage inverter (negative voltage required for LCD contrast, without this, writing to display will not be possible)
